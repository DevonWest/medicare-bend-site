...
- These are PNG files. If the site currently references .svg versions, update the paths to .png.
- Use Next/Image with width/height and lazy loading below the fold.
- Use empty alt text for decorative images; use descriptive alt text where meaningful.
